...
public class CheckboxesTest<softAssert> {
    ...
    public void checkCheckboxes() {
        ...
        softAssert.assertFalse(checkbox1Unchecked);
        ...
        softAssert.assertTrue(checkbox2Checked);
        ...
        softAssert.assertFalse(checkbox2Unchecked);
